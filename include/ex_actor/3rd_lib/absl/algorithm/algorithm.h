...
#ifndef EX_ACTOR_ABSL_ALGORITHM_ALGORITHM_H_
#define EX_ACTOR_ABSL_ALGORITHM_ALGORITHM_H_
...
EX_ACTOR_ABSL_INTERNAL_CONSTEXPR_SINCE_CXX20 bool linear_search(
...
#endif  // EX_ACTOR_ABSL_ALGORITHM_ALGORITHM_H_
