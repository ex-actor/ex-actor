...
#ifndef EX_ACTOR_ABSL_BASE_INTERNAL_ITERATOR_TRAITS_H_
#define EX_ACTOR_ABSL_BASE_INTERNAL_ITERATOR_TRAITS_H_
...
struct IteratorCategory<
    Iterator,
    ex_actor::embedded_3rd::absl::void_t<typename std::iterator_traits<Iterator>::iterator_category>> {
...
struct IteratorConceptImpl<
    Iterator,
    ex_actor::embedded_3rd::absl::void_t<typename std::iterator_traits<Iterator>::iterator_concept>> {
...
#endif  // EX_ACTOR_ABSL_BASE_INTERNAL_ITERATOR_TRAITS_H_
