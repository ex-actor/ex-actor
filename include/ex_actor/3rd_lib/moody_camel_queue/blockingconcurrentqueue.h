...
class BlockingConcurrentQueue {
 private:
  using ConcurrentQueue = ::ex_actor::embedded_3rd::moodycamel::ConcurrentQueue<T, Traits>;
  using LightweightSemaphore = ::ex_actor::embedded_3rd::moodycamel::LightweightSemaphore;
...
}  // end namespace ex_actor::embedded_3rd::moodycamel
